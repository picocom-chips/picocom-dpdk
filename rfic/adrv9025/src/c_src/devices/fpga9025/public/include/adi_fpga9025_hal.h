 ...
 */
#ifndef _ADI_FPGA9025_HAL_H_
#define _ADI_FPGA9025_HAL_H_
...
/**
* \brief Performs a RAM memory read. ramAddress should be from 0GB - 16GB and must be on a 32-word boundary.
*
* \dep_begin
* \dep{device}
* \dep_end
...
/**
* \brief Performs a RAM memory write. ramAddress should be from 0GB - 16GB and must be on a 32-word boundary.
*
* \dep_begin
* \dep{device}
* \dep_end
