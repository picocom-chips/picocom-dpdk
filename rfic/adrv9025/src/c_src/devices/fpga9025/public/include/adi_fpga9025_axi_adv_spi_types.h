...
#ifndef _ADI_FPGA9025_AXI_ADV_SPI_TYPES_H_
#define _ADI_FPGA9025_AXI_ADV_SPI_TYPES_H_
...
typedef struct adi_fpga9025_AxiAdvSpiVersion
{
...
} adi_fpga9025_AxiAdvSpiVersion_t;

//    typedef struct adi_fpga9025_AxiAdvSpiDgier
//    {
...
//    } adi_fpga9025_AxiAdvSpiDgier_t;

typedef struct adi_fpga9025_AxiAdvSpiIpisr
{
...
} adi_fpga9025_AxiAdvSpiIpisr_t;

typedef struct adi_fpga9025_AxiAdvSpiIpier
{
...
} adi_fpga9025_AxiAdvSpiIpier_t;

/**
* \brief Data structure to hold SPI settings for all system device types
*/
typedef struct adi_fpga9025_AxiAdvSpiSpicr
{
...
} adi_fpga9025_AxiAdvSpiSpicr_t;

/**
 * \brief Data structure to hold SPI settings for all system device types
 */
typedef struct adi_fpga9025_AxiAdvSpiSpisr
{
...
} adi_fpga9025_AxiAdvSpiSpisr_t;

typedef struct adi_fpga9025_AxiAdvSpiFeatConfig
{
...
} adi_fpga9025_AxiAdvSpiFeatConfig_t;

//    typedef struct adi_fpga9025_AxiAdvSpiSpidtr
//    {
//        uint8_t tx_data;                     /*!< Transmit Data. Data to be pushed into the TX Data FIFO.*/
//    } adi_fpga9025_AxiAdvSpiSpidtr_t;

//    typedef struct adi_fpga9025_AxiAdvSpiSpidrr
//    {
//        uint8_t rx_data;                     /*!< Transmit Data. Data to be pushed into the TX Data FIFO.*/
//    } adi_fpga9025_AxiAdvSpiSpidrr_t;

//    typedef struct adi_fpga9025_AxiAdvSpiSpissr
//    {
//        uint32_t slave_select;                     /*!< Slave Select. Active-Low, one-hot encoded slave select vector.*/
//    } adi_fpga9025_AxiAdvSpiSpissr_t;

//    typedef struct adi_fpga9025_AxiAdvSpiTxFIFOocy
//    {
...
//    } adi_fpga9025_AxiAdvSpiTxFIFOocy_t;

typedef struct adi_fpga9025_axiAdvSpiSettings
{
    adi_fpga9025_AxiAdvSpiVersion_t    spiModVersion;      /*!< axi_adv_spi module version */
    adi_fpga9025_AxiAdvSpiIpisr_t      spiIntStatus;       /*!< The IP Interrupt Status Register */
    adi_fpga9025_AxiAdvSpiIpier_t      spiIntEnable;       /*!<  Interrupt Enable Register */
    adi_fpga9025_AxiAdvSpiSpicr_t      spiCtrlRegSettings; /*!< SPI settings data structure */
    adi_fpga9025_AxiAdvSpiSpisr_t      SpiStatus;          /*!< Holds settings for CLKPLL and reference clock */
    adi_fpga9025_AxiAdvSpiFeatConfig_t advFeatSS[32];      /*!< Advanced Feature Configuration Register for Slave Select 0-31. */
} adi_fpga9025_axiAdvSpiSettings_t;

#ifdef __cplusplus
}
#endif

#endif /* _ADI_FPGA9025_AXI_ADV_SPI_TYPES_H_ */
