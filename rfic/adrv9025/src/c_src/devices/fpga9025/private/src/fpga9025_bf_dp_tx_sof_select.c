/**
 * \file fpga9025_bf_dp_tx_sof_select.c Automatically generated file with generator ver 0.0.1.0.
 *
...
#include "./../../private/include/fpga9025_bf_dp_tx_sof_select.h"
 ...
 *  Parameter is of type ::fpga9025_BfDpTxSofSelectChanAddr_e.
                                         ...
                                         uint8_t                            bfValue)
{
        ...
        (bfValue > 63U))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         bfValue,
                         "Invalid fpga9025_DpTxSofSelectDelayBfSet parameter");
    ...
    /* Base Address check */
    if ((baseAddr != FPGA9025_BF_DP_TX_SOF_SELECT))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ADI_COMMON_ERRSRC_DEVICEBF, 
                         ADI_COMMON_ERR_INV_PARAM, 
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9025_DpTxSofSelectDelayBfSet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
                                         ...
                                         uint8_t*                           bfValue)
{
    ...
    if ((baseAddr != FPGA9025_BF_DP_TX_SOF_SELECT))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9025_DpTxSofSelectDelayBfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_ADDR_CHECK */
                                                      ...
                                                      uint8_t*                           bfValue)
{
    ...
    if ((baseAddr != FPGA9025_BF_DP_TX_SOF_SELECT))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9025_DpTxSofSelectModuleVersionMajorBfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_ADDR_CHECK */
                                                      ...
                                                      uint16_t*                          bfValue)
{
    ...
    if ((baseAddr != FPGA9025_BF_DP_TX_SOF_SELECT))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9025_DpTxSofSelectModuleVersionMinorBfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_ADDR_CHECK */
                                         ...
                                         uint8_t                            bfValue)
{
        ...
        (bfValue > 1U))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM, 
                         bfValue,
                         "Invalid fpga9025_DpTxSofSelectResetBfSet parameter");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_VALUE_CHECK */
    ...
    if ((baseAddr != FPGA9025_BF_DP_TX_SOF_SELECT))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9025_DpTxSofSelectResetBfSet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_ADDR_CHECK */
                                         ...
                                         uint8_t*                           bfValue)
{
    ...
    if ((baseAddr != FPGA9025_BF_DP_TX_SOF_SELECT))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9025_DpTxSofSelectResetBfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_ADDR_CHECK */
                                          ...
                                          uint8_t                            bfValue)
{
        ...
        (bfValue > 7U))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM, 
                         bfValue,
                         "Invalid fpga9025_DpTxSofSelectSelectBfSet parameter");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_VALUE_CHECK */
    ...
    if ((baseAddr != FPGA9025_BF_DP_TX_SOF_SELECT))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9025_DpTxSofSelectSelectBfSet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_ADDR_CHECK */
                                          ...
                                          uint8_t*                           bfValue)
{
    ...
    if ((baseAddr != FPGA9025_BF_DP_TX_SOF_SELECT))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9025_DpTxSofSelectSelectBfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_ADDR_CHECK */
...
/*  EOF: fpga9025_bf_dp_tx_sof_select.c */
