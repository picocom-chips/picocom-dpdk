/*!
* \file adi_fpga9010_rx_types.h
* \brief Contains FPGA9010 rx enum and struct definitions
*
...
#ifndef _ADI_FPGA9010_RX_TYPES_H_
#define _ADI_FPGA9010_RX_TYPES_H_
...
#define ADI_FPGA9010_NUM_OF_RX_DATAMOVERS 3
    
/**
* \brief Enumerated list of fpga Rx Tollgata trigger sources
*/
typedef enum adi_fpga9010_RxTollgateTrigSources
{
    ADI_FPGA9010_IMM_TRIG = 0x1,              /*!Immediate trigger. */
    ADI_FPGA9010_EXT_TRIG = 0x2,              /*!External Trigger external SMA. */
    ADI_FPGA9010_TDD_SM = 0x4,              /*!TDD State Machine. */
    ADI_FPGA9010_ARM_ACK = 0x8,              /*!GPIO. */
    ADI_FPGA9010_TX1_SOF = 0x10,              /*!TX1 Start of File Flag from transmit to indicate start of transmit tone.*/
    ADI_FPGA9010_TX2_SOF = 0x20,             /*!TX2 Start of File Flag from transmit to indicate start of transmit tone. */
    ADI_FPGA9010_TX3_SOF = 0x40,             /*!TX3 Start of File Flag from transmit to indicate start of transmit tone. */
    ADI_FPGA9010_TX4_SOF = 0x80              /*!TX4 Start of File Flag from transmit to indicate start of transmit tone. */
} adi_fpga9010_RxTollgateTrigSources_e;

/**
*  \brief Data structure to hold the Fpga Data mover tollgate Configuration
*/
typedef struct adi_fpga9010_RxTollgateCfg
{
    ...
    adi_fpga9010_RxTollgateTrigSources_e tollGateTrigSource;    /*!Selects the trigger input that is used to open the Tollgate. multiple triggers Supported */
} adi_fpga9010_RxTollgateCfg_t;

/**
*  \brief Data structure to hold the Fpga Data mover dma Configuration
*/
typedef struct adi_fpga9010_RxDmaCfg
{
...
} adi_fpga9010_RxDmaCfg_t;

#ifdef __cplusplus
}
#endif

#endif /* _ADI_FPGA9010_RX_TYPES_H_ */