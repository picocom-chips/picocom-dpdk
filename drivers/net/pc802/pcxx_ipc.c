...
#ifdef MULTI_PC802
static PC802_Traffic_Type_e QID_DATA[CELL_NUM_PRE_DEV] = { PC802_TRAFFIC_DATA_1, PC802_TRAFFIC_DATA_2, PC802_TRAFFIC_CTRL_4};
static PC802_Traffic_Type_e QID_CTRL[CELL_NUM_PRE_DEV+1] = { PC802_TRAFFIC_CTRL_1, PC802_TRAFFIC_CTRL_2, PC802_TRAFFIC_CTRL_3, PC802_TRAFFIC_CTRL_4};
#else
