...
typedef enum PC802_Traffic_Type_e {
    ...
    PC802_TRAFFIC_1ST_CELL_DATA,
    PC802_TRAFFIC_5G_EMBB_DATA = PC802_TRAFFIC_1ST_CELL_DATA,
    PC802_TRAFFIC_1ST_CELL_CTRL,
    PC802_TRAFFIC_5G_EMBB_CTRL = PC802_TRAFFIC_1ST_CELL_CTRL,

    PC802_TRAFFIC_5G_URLLC,

    PC802_TRAFFIC_2ND_CELL_DATA,
    PC802_TRAFFIC_4G_LTE_DATA = PC802_TRAFFIC_2ND_CELL_DATA,
    PC802_TRAFFIC_2ND_CELL_CTRL,
    PC802_TRAFFIC_4G_LTE_CTRL = PC802_TRAFFIC_2ND_CELL_CTRL,

    PC802_TRAFFIC_OAM1,
    PC802_TRAFFIC_OAM = PC802_TRAFFIC_OAM1,
    PC802_TRAFFIC_OAM2,
