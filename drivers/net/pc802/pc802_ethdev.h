...
typedef enum PC802_ReqRspInd_e{
    ...
    PC802_RESET_WITH_MB_REQ,
    PC802_RESET_WITH_MB_RSP = PC802_RESET_WITH_MB_REQ,
    PC802_RESET_WITHOUT_MB_REQ,
    PC802_RESET_WITHOUT_MB_RSP = PC802_RESET_WITHOUT_MB_REQ,
