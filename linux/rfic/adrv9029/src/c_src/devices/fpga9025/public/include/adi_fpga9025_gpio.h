...
#ifndef _ADI_FPGA9025_GPIO_H_
#define _ADI_FPGA9025_GPIO_H_
...
*
* \param device Pointer to the FPGA9025 data structure
...
*  similar functionality to adi_fpga9025_GpioInputDirGet but with a different signiture
*
...
* similar functionality to adi_fpga9025_GpioInputDirSet but with a different signiture
*
...
* \param device Pointer to the FPGA9025 data structure
* \param tddModuleSel The selected TDD module.
* \param gpioSel A pointer to adi_fpga9025_GpioPinSel_e that will hold the GPIO for the selected TDD module.
* \retval ADI_COMMON_ACT_WARN_RESET_LOG Recovery action for log reset.
* \retval ADI_COMMON_ACT_ERR_CHECK_PARAM Recovery action for bad parameter check.
* \retval ADI_COMMON_ACT_NO_ACTION Function completed successfully, no action required.
*/
