/**
 * \file fpga9025_bf_tdd_frame_cnt.c Automatically generated file with generator ver 0.0.1.0.
 *
 ...
 *  Parameter is of type ::fpga9025_BfTddFrameCntChanAddr_e.
                                        ...
                                        uint8_t                          bfValue)
{
        ...
        (bfValue > 1U))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         bfValue,
                         "Invalid fpga9025_TddFrameCntEnableBfSet parameter");
    ...
    /* Base Address check */
    if ((baseAddr != FPGA9025_BF_TDD_FRAME_COUNTER))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ADI_COMMON_ERRSRC_DEVICEBF, 
                         ADI_COMMON_ERR_INV_PARAM, 
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9025_TddFrameCntEnableBfSet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
                                        ...
                                        uint8_t*                         bfValue)
{
    ...
    if ((baseAddr != FPGA9025_BF_TDD_FRAME_COUNTER))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9025_TddFrameCntEnableBfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_ADDR_CHECK */
                                          ...
                                          uint32_t                         bfValue)
{
        ...
        (bfValue > 4294967295U))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM, 
                         bfValue,
                         "Invalid fpga9025_TddFrameCntEndValueBfSet parameter");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_VALUE_CHECK */
    ...
    if ((baseAddr != FPGA9025_BF_TDD_FRAME_COUNTER))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9025_TddFrameCntEndValueBfSet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_ADDR_CHECK */
                                          ...
                                          uint32_t*                        bfValue)
{
    ...
    if ((baseAddr != FPGA9025_BF_TDD_FRAME_COUNTER))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9025_TddFrameCntEndValueBfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_ADDR_CHECK */
                                           ...
                                           uint32_t                         bfValue)
{
        ...
        (bfValue > 4294967295U))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM, 
                         bfValue,
                         "Invalid fpga9025_TddFrameCntLoopCountBfSet parameter");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_VALUE_CHECK */
    ...
    if ((baseAddr != FPGA9025_BF_TDD_FRAME_COUNTER))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9025_TddFrameCntLoopCountBfSet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_ADDR_CHECK */
                                           ...
                                           uint32_t*                        bfValue)
{
    ...
    if ((baseAddr != FPGA9025_BF_TDD_FRAME_COUNTER))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9025_TddFrameCntLoopCountBfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_ADDR_CHECK */
                                             ...
                                             uint8_t                          bfValue)
{
        ...
        (bfValue > 1U))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM, 
                         bfValue,
                         "Invalid fpga9025_TddFrameCntLoopCountEnBfSet parameter");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_VALUE_CHECK */
    ...
    if ((baseAddr != FPGA9025_BF_TDD_FRAME_COUNTER))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9025_TddFrameCntLoopCountEnBfSet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_ADDR_CHECK */
                                             ...
                                             uint8_t*                         bfValue)
{
    ...
    if ((baseAddr != FPGA9025_BF_TDD_FRAME_COUNTER))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9025_TddFrameCntLoopCountEnBfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_ADDR_CHECK */
                                         ...
                                         uint8_t                          bfValue)
{
        ...
        (bfValue > 1U))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM, 
                         bfValue,
                         "Invalid fpga9025_TddFrameCntTriggerBfSet parameter");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_VALUE_CHECK */
    ...
    if ((baseAddr != FPGA9025_BF_TDD_FRAME_COUNTER))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9025_TddFrameCntTriggerBfSet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_ADDR_CHECK */
                                         ...
                                         uint8_t*                         bfValue)
{
    ...
    if ((baseAddr != FPGA9025_BF_TDD_FRAME_COUNTER))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9025_TddFrameCntTriggerBfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_ADDR_CHECK */
                                              ...
                                              uint8_t*                         bfValue)
{
    ...
    if ((baseAddr != FPGA9025_BF_TDD_FRAME_COUNTER))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9025_TddFrameCntVersionMajorBfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_ADDR_CHECK */
                                              ...
                                              uint16_t*                        bfValue)
{
    ...
    if ((baseAddr != FPGA9025_BF_TDD_FRAME_COUNTER))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9025_TddFrameCntVersionMinorBfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_ADDR_CHECK */
...
/*  EOF: fpga9025_bf_tdd_frame_cnt.c */
