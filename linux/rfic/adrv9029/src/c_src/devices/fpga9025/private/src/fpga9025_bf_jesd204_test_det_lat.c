/**
 * \file fpga9025_bf_jesd204_test_det_lat.c Automatically generated file with generator ver 0.0.1.0.
 *
...
#include "./../../private/include/fpga9025_bf_jesd204_test_det_lat.h"
 ...
 *  Parameter is of type ::fpga9025_BfJesd204TestDetLatChanAddr_e.
                                              ...
                                              uint8_t                                bfValue)
{
        ...
        (bfValue > 1U))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         bfValue,
                         "Invalid fpga9025_Jesd204TestDetLatEnableBfSet parameter");
    ...
    /* Base Address check */
    if ((baseAddr != FPGA9025_BF_JESD204_TEST_DET_LAT))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ADI_COMMON_ERRSRC_DEVICEBF, 
                         ADI_COMMON_ERR_INV_PARAM, 
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9025_Jesd204TestDetLatEnableBfSet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
                                              ...
                                              uint8_t*                               bfValue)
{
    ...
    if ((baseAddr != FPGA9025_BF_JESD204_TEST_DET_LAT))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9025_Jesd204TestDetLatEnableBfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_ADDR_CHECK */
                                               ...
                                               uint32_t*                              bfValue)
{
    ...
    if ((baseAddr != FPGA9025_BF_JESD204_TEST_DET_LAT))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9025_Jesd204TestDetLatLatencyBfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_ADDR_CHECK */
                                                          ...
                                                          uint8_t*                               bfValue)
{
    ...
    if ((baseAddr != FPGA9025_BF_JESD204_TEST_DET_LAT))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9025_Jesd204TestDetLatModuleVersionMajorBfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_ADDR_CHECK */
                                                          ...
                                                          uint16_t*                              bfValue)
{
    ...
    if ((baseAddr != FPGA9025_BF_JESD204_TEST_DET_LAT))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9025_Jesd204TestDetLatModuleVersionMinorBfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_ADDR_CHECK */
                                              ...
                                              uint8_t                                bfValue)
{
        ...
        (bfValue > 3U))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM, 
                         bfValue,
                         "Invalid fpga9025_Jesd204TestDetLatRxLinkBfSet parameter");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_VALUE_CHECK */
    ...
    if ((baseAddr != FPGA9025_BF_JESD204_TEST_DET_LAT))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9025_Jesd204TestDetLatRxLinkBfSet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_ADDR_CHECK */
                                              ...
                                              uint8_t*                               bfValue)
{
    ...
    if ((baseAddr != FPGA9025_BF_JESD204_TEST_DET_LAT))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9025_Jesd204TestDetLatRxLinkBfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_ADDR_CHECK */
                                              ...
                                              uint8_t                                bfValue)
{
        ...
        (bfValue > 3U))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM, 
                         bfValue,
                         "Invalid fpga9025_Jesd204TestDetLatTxLinkBfSet parameter");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_VALUE_CHECK */
    ...
    if ((baseAddr != FPGA9025_BF_JESD204_TEST_DET_LAT))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9025_Jesd204TestDetLatTxLinkBfSet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_ADDR_CHECK */
                                              ...
                                              uint8_t*                               bfValue)
{
    ...
    if ((baseAddr != FPGA9025_BF_JESD204_TEST_DET_LAT))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9025_Jesd204TestDetLatTxLinkBfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_ADDR_CHECK */
                                                      ...
                                                      uint8_t                                bfValue)
{
        ...
        (bfValue > 15U))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM, 
                         bfValue,
                         "Invalid fpga9025_Jesd204TestDetLatValidDataWidthBfSet parameter");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_VALUE_CHECK */
    ...
    if ((baseAddr != FPGA9025_BF_JESD204_TEST_DET_LAT))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9025_Jesd204TestDetLatValidDataWidthBfSet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_ADDR_CHECK */
                                                      ...
                                                      uint8_t*                               bfValue)
{
    ...
    if ((baseAddr != FPGA9025_BF_JESD204_TEST_DET_LAT))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9025_Jesd204TestDetLatValidDataWidthBfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_ADDR_CHECK */
...
/*  EOF: fpga9025_bf_jesd204_test_det_lat.c */
