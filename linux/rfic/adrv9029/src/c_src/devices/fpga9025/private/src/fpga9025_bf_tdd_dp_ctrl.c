/**
 * \file fpga9025_bf_tdd_dp_ctrl.c Automatically generated file with generator ver 0.0.1.0.
 *
 ...
 *  Parameter is of type ::fpga9025_BfTddDpCtrlChanAddr_e.
                                         ...
                                         uint8_t                        bfValue)
{
        ...
        (bfValue > 1U))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         bfValue,
                         "Invalid fpga9025_TddDpCtrlEnableBitBfSet parameter");
    ...
    /* Base Address check */
    if ((baseAddr != FPGA9025_BF_TDD_DATAPATH_CONTROL_RX_DP_0) &&
            (baseAddr != FPGA9025_BF_TDD_DATAPATH_CONTROL_RX_DP_1) &&
            (baseAddr != FPGA9025_BF_TDD_DATAPATH_CONTROL_TX_DP_0) &&
            (baseAddr != FPGA9025_BF_TDD_DATAPATH_CONTROL_RX_DP_2) &&
            (baseAddr != FPGA9025_BF_TDD_DATAPATH_CONTROL_TX_DP_1))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ADI_COMMON_ERRSRC_DEVICEBF, 
                         ADI_COMMON_ERR_INV_PARAM, 
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9025_TddDpCtrlEnableBitBfSet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
                                         ...
                                         uint8_t*                       bfValue)
{
            ...
            (baseAddr != FPGA9025_BF_TDD_DATAPATH_CONTROL_TX_DP_1))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9025_TddDpCtrlEnableBitBfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_ADDR_CHECK */
...
/**
 * \brief Start Value for Datapath Control Module
 * 
 * \dep_begin
 * \dep{device->common.devHalInfo}
 * \dep_end
                                          ...
                                          uint32_t                       bfValue)
{
        ...
        (bfValue > 4294967295U))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM, 
                         bfValue,
                         "Invalid fpga9025_TddDpCtrlStartValueBfSet parameter");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_VALUE_CHECK */
            ...
            (baseAddr != FPGA9025_BF_TDD_DATAPATH_CONTROL_TX_DP_1))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9025_TddDpCtrlStartValueBfSet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_ADDR_CHECK */
                                            ...
                                            uint8_t*                       bfValue)
{
            ...
            (baseAddr != FPGA9025_BF_TDD_DATAPATH_CONTROL_TX_DP_1))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9025_TddDpCtrlVersionMajorBfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_ADDR_CHECK */
                                            ...
                                            uint16_t*                      bfValue)
{
            ...
            (baseAddr != FPGA9025_BF_TDD_DATAPATH_CONTROL_TX_DP_1))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9025_TddDpCtrlVersionMinorBfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_ADDR_CHECK */
