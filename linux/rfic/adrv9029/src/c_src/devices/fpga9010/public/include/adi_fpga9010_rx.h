/**
 * \file: adi_fpga9010_rx.h
 *
 * \brief Contains top level rx fpga9010 related prototypes
 *
...
#ifndef _ADI_FPGA9010_RX_H_
#define _ADI_FPGA9010_RX_H_
...
/**
* \brief    This function writes the adi_fpga9010_RxTollgateCfg_t structure to the tollgate
...
* \param rxDatamoverSelMask an or'd combination of one or more adi_fpga9010_DeframerSel_e enum values
...
*           adi_fpga9010_RxTollgateCfg_t structure passed in to the function.
*
* \dep_begin
* \dep{device}
* \dep_end
*
* \param device Pointer to the FPGA9010 device data structure.
* \param rxDatamoverSel an adi_fpga9010_DeframerSel_e enum value selecting a single datamover
...
*           adi_fpga9010_DeframerSel_e enum.
*
* \dep_begin
* \dep{device}
* \dep_end
...
* \param device Pointer to the FPGA9010 device data structure.
* \param rxDatamoverSel an adi_fpga9010_DeframerSel_e enum value selecting a single datamover
* \param triggerSelect pointer to an adi_fpga9010_RxTollgateTrigSources_e enum to hold the readback value
*
* \retval ADI_FPGA9010_ACT_RESET_LOG Recovery action for log reset
* \retval ADI_COMMON_ACT_ERR_CHECK_PARAM Recovery action for bad parameter check
* \retval ADI_COMMON_ACT_NO_ACTION Function completed successfully, no action required
...
/**
* \brief    This function writes the adi_fpga9010_RxDmaCfg_t structure to the DMA
*           modules selected in the rxDatamoverSelMask. This function could be used as part
...
/**
* \brief    This function writes the static members of the adi_fpga9010_RxDmaCfg_t structure to the DMA
...
*           adi_fpga9010_RxDmaCfg_t structure passed in to the function. This function reads
...
* \retval ADI_FPGA9010_ACT_RESET_LOG Recovery action for log reset
* \retval ADI_COMMON_ACT_ERR_CHECK_PARAM Recovery action for bad parameter check
* \retval ADI_FPGA9010_ACT_INV_RX_DATA_MOVER_ENABLE An invalid rx data mover trigger selected
* \retval ADI_COMMON_ACT_NO_ACTION Function completed successfully, no action required
*
*/
...
*           is configured using adi_fpga9010_RxTollgateTriggerSet,
*           the DMA is reset then configured using adi_fpga9010_RxDmaSet,
*           the DMA is started by setting the run-stop bit using adi_fpga9010_RxDmaRunStopSet,
...
/**
* \brief    Called after adi_fpga9010_RxCaptureStart to block program execution until the capture completes
