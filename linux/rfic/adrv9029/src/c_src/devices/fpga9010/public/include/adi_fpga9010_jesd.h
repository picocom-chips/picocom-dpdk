...
#ifndef _ADI_FPGA9010_JESD_H_
#define _ADI_FPGA9010_JESD_H_
...
* \param laneSel an  adi_fpga9010_LaneSel_e enum value
...
*
* \param device Pointer to the FPGA9010 device data structure.
* \param laneSelMask an  adi_fpga9010_LaneSel_e enum value
...
*
* \param device Pointer to the FPGA9010 device data structure.
* \param laneSelMask an or'd combination of one or more adi_fpga9010_LaneSel_e enum values
...
/**
* \brief    This function writes the adi_fpga9010_DeframerCfg_t structure to the framer modules
...
*/
 ...
 /**
 * \brief    Reads the configuration for a single deframer module and populates the empty adi_fpga9010_DeframerCfg_t
 ...
 *
 * \param device Pointer to the FPGA9010 device data structure.
 * \param deframerSel an  adi_fpga9010_LinkSel_e enum value
 ...
 * \param device Pointer to the FPGA9010 device data structure.
 * \param deframerSelMask an or'd combination of one or more adi_fpga9010_DeframerSel_e enum values
 * \param resetBits the reset bits of the selected deframers will correspond with their adi_fpga9010_DeframerSel_e bit locations
 *
 * \retval ADI_FPGA9010_ACT_RESET_LOG Recovery action for log reset
 * \retval ADI_COMMON_ACT_ERR_CHECK_PARAM Recovery action for bad parameter check
 * \retval ADI_COMMON_ACT_NO_ACTION Function completed successfully, no action required
 ...
 */
 ...
 /**
 * \brief   This function writes the adi_fpga9010_FramerCfg_t structure to the framer modules
...
/**
* \brief    Reads the configuration for a single framer module and populates the empty adi_fpga9010_FramerCfg_t
...
* \param device Pointer to the FPGA9010 device data structure.
* \param framerSelMask an or'd combination of one or more adi_fpga9010_FramerSel_e enum values
* \param resetBits the reset bits of the selected deframers will correspond with their adi_fpga9010_FramerSel_e bit locations
*
* \retval ADI_FPGA9010_ACT_RESET_LOG Recovery action for log reset
* \retval ADI_COMMON_ACT_ERR_CHECK_PARAM Recovery action for bad parameter check
* \retval ADI_COMMON_ACT_NO_ACTION Function completed successfully, no action required
...
*
* \param device Pointer to the FPGA9010 device data structure.
* \param framerSel adi_fpga9010_FramerSel_e enum value to select the laneXBar
...
*
* \param device Pointer to the FPGA9010 device data structure.
* \param deframerSel adi_fpga9010_DeframerSel_e enum value to select which deframer
* \param laneXBar  an eight element array holding the PHY lane assignments for each output lane
*
* \retval ADI_FPGA9010_ACT_RESET_LOG Recovery action for log reset
* \retval ADI_COMMON_ACT_ERR_CHECK_PARAM Recovery action for bad parameter check
...
*
* \param device Pointer to the FPGA9010 device data structure.
* \param framerSel adi_fpga9010_FramerSel_e enum value to select which framer
...
*           function should be called after adi_fpga9010_FramerCfgSet as part of link bringup.
...
* \param device Pointer to the FPGA9010 device data structure.
* \param deframerSelMask an or'd combination of one or more adi_fpga9010_DeframerSel_e enum values
* \param status the Sync status bits of the selected deframers will correspond with their adi_fpga9010_DeframerSel_e bit locations
*
* \retval ADI_FPGA9010_ACT_RESET_LOG Recovery action for log reset
* \retval ADI_COMMON_ACT_ERR_CHECK_PARAM Recovery action for bad parameter check
* \retval ADI_COMMON_ACT_NO_ACTION Function completed successfully, no action required
...
*           interruptBitMask is an or'd combination of the adi_fpga9010_Jesd204cIrq_e enum.
...
*
* \param device Pointer to the FPGA9010 device data structure.
* \param interruptBitMask uint16_t bitmask of adi_fpga9010_Jesd204cIrq_e indicating the IRQs to be enabled/disabled.
*
* \retval ADI_FPGA9010_ACT_RESET_LOG Recovery action for log reset
* \retval ADI_COMMON_ACT_ERR_CHECK_PARAM Recovery action for bad parameter check
* \retval ADI_COMMON_ACT_NO_ACTION Function completed successfully, no action required
...
*           adi_fpga9010_Jesd204cIrq_e enum.
...
*
*/
int32_t adi_fpga9010_Jesd204cLinkLayerIrqEnGet(adi_fpga9010_Device_t *device, uint8_t linkSelMask, uint16_t *interruptBitMask);
