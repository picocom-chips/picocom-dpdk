/*!
* \file adi_fpga9010_tdd_types.h
* \brief Contains FPGA9010 TDD enum and struct definitions
*
...
#ifndef _ADI_FPGA9010_TDD_TYPES_H_
#define _ADI_FPGA9010_TDD_TYPES_H_

#include <stdint.h>
//#include "adi_fpga_tdd_types.h"
...
*/
typedef enum adi_fpga9010_OrxPinEncodeModes
{
    ADI_FPGA9010_ORXPINENCODE_MODE1 = 0, /* 3 pin mode (ORx_Enable and ORx_Select[1:0] pins) */
    ADI_FPGA9010_ORXPINENCODE_MODE1A = 1, /* 2 pin mode (ORx_Enable and ORx_Select pins) */
    ADI_FPGA9010_ORXPINENCODE_MODE2 = 2, /* 4 pin mode (2 ORx_Enable pins and 2 ORx Select pins) */
    ADI_FPGA9010_ORXPINENCODE_MODE3 = 3, /* 1 pin mode (ORx selection is accomplished via SPI bits) */
    ADI_FPGA9010_ORXPINENCODE_MODE4 = 4 /* 2 pin mode (ORx selection is accomplished via SPI bits) */
}adi_fpga9010_OrxPinEncodeModes_e;
...
*/
typedef struct adi_fpga9010_TddTiming
{
...
*           Control FPGA module.
*/
typedef struct adi_fpga9010_TddDatapathControl
{
...
} adi_fpga9010_TddDatapathControl_t;

/**
*  \brief   Structure to hold the FPGA TDD state machine parameters
*/
typedef struct adi_fpga9010_TddStateMachine
{
    ...
    adi_fpga9010_TddTiming_t rx1EnableControl;
    adi_fpga9010_TddTiming_t rx2EnableControl;
    adi_fpga9010_TddTiming_t rx3EnableControl;
    adi_fpga9010_TddTiming_t rx4EnableControl;

    adi_fpga9010_TddTiming_t orx1EnableControl;
    adi_fpga9010_TddTiming_t orx2EnableControl;
    adi_fpga9010_TddTiming_t orx3EnableControl;
    adi_fpga9010_TddTiming_t orx4EnableControl;

    adi_fpga9010_TddTiming_t tx1EnableControl;
    adi_fpga9010_TddTiming_t tx2EnableControl;
    adi_fpga9010_TddTiming_t tx3EnableControl;
    adi_fpga9010_TddTiming_t tx4EnableControl;

    adi_fpga9010_TddTiming_t tx1ToOrx1EnableControl;
    adi_fpga9010_TddTiming_t tx2ToOrx1EnableControl;
    adi_fpga9010_TddTiming_t tx1ToOrx2EnableControl;
    adi_fpga9010_TddTiming_t tx2ToOrx2EnableControl;
    adi_fpga9010_TddTiming_t tx3ToOrx3EnableControl;
    adi_fpga9010_TddTiming_t tx4ToOrx3EnableControl;
    adi_fpga9010_TddTiming_t tx3ToOrx4EnableControl;
    adi_fpga9010_TddTiming_t tx4ToOrx4EnableControl;
    
    adi_fpga9010_TddTiming_t extTrig1;
    adi_fpga9010_TddTiming_t extTrig2;
    adi_fpga9010_TddTiming_t extTrig3;
    adi_fpga9010_TddTiming_t extTrig4;
    
    adi_fpga9010_TddDatapathControl_t rxDatapath0;
    adi_fpga9010_TddDatapathControl_t rxDatapath1;
    adi_fpga9010_TddDatapathControl_t rxDatapath2;
    adi_fpga9010_TddDatapathControl_t txDatapath0;
    adi_fpga9010_TddDatapathControl_t txDatapath1;

} adi_fpga9010_TddStateMachine_t;

typedef enum adi_fpga9010_TddGpioModule
{
    ADI_FPGA9010_ENABLE1CONTROL,
    ADI_FPGA9010_ENABLE2CONTROL,
    ADI_FPGA9010_ENABLE3CONTROL,
    ADI_FPGA9010_ENABLE4CONTROL,
    ADI_FPGA9010_SELECT1CONTROL,
    ADI_FPGA9010_SELECT2CONTROL,
    ADI_FPGA9010_SELECT3CONTROL,
    ADI_FPGA9010_SELECT4CONTROL

} adi_fpga9010_TddModule_e;

/**
*  \brief   Structure to hold the FPGA TDD Orx Pin Encode module parameters
*/
typedef struct adi_fpga9010_OrxPinEncodeCfg
{
    adi_fpga9010_OrxPinEncodeModes_e modeSelect;     /*!< Selects the ORX Pin mode encoding. */
...
}adi_fpga9010_OrxPinEncodeCfg_t;

#ifdef __cplusplus
}
#endif

#endif  /* _ADI_FPGA9010_TDD_TYPES_H_ */
