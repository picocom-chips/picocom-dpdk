...
#ifndef _ADI_FPGA9010_TX_H_
#define _ADI_FPGA9010_TX_H_
...
/**
* \brief    This function writes the adi_fpga9010_TxTollgateCfg_t structure to the tollgate
...
* \param txDataMoverSelMask an or'd combination of one or more adi_fpga9010_FramerSel_e enum values
...
*           adi_fpga9010_TxTollgateCfg_t structure passed in to the function.
*
* \dep_begin
* \dep{device}
* \dep_end
*
* \param device Pointer to the FPGA9010 device data structure.
* \param txDataMoverSel an adi_fpga9010_FramerSel_e enum value selecting a single datamover
* \param tollGateCfg an empty structure that will be written with the selected tollgate's configuration values
*
* \retval ADI_FPGA9010_ACT_RESET_LOG Recovery action for log reset
* \retval ADI_COMMON_ACT_ERR_CHECK_PARAM Recovery action for bad parameter check
* \retval ADI_FPGA9010_ACT_INV_TX_DATA_MOVER_TOLLGATE_SETUP An invalid tx datamover selected
* \retval ADI_COMMON_ACT_NO_ACTION Function completed successfully, no action required
*
*/
...
/**
* \brief    This function writes the adi_fpga9010_TxDmaCfg_t structure to the DMA
*           modules selected in the txDatamoverSelMask. This function could be used as part
...
* \retval ADI_FPGA9010_ACT_RESET_LOG Recovery action for log reset
* \retval ADI_COMMON_ACT_ERR_CHECK_PARAM Recovery action for bad parameter check
* \retval ADI_FPGA9010_ACT_INV_TX_DATA_MOVER_DMA_SETUP An invalid tx datamover selected
* \retval ADI_COMMON_ACT_NO_ACTION Function completed successfully, no action required
*
*/   
...
*           adi_fpga9010_TxDmaCfg_t structure passed in to the function. This function reads
...
*
* \param device Pointer to the FPGA9010 device data structure.
* \param txDataMoverSel anadi_fpga9010_FramerSel_e enum values
* \param dmaCfg Pointer to return the adi_fpga9010_TxDmaCfg_t data structure.
*
* \retval ADI_FPGA9010_ACT_RESET_LOG Recovery action for log reset
* \retval ADI_COMMON_ACT_ERR_CHECK_PARAM Recovery action for bad parameter check
* \retval ADI_FPGA9010_ACT_INV_TX_DATA_MOVER_DMA_SETUP An invalid tx datamover selected
...
*
*/
int32_t adi_fpga9010_TxDmaGet(adi_fpga9010_Device_t *device, adi_fpga9010_FramerSel_e txDataMoverSel, adi_fpga9010_TxDmaCfg_t *dmaCfg);
...
* \param device Pointer to the FPGA9010 device data structure.
* \param txDataMoverSelMask an or'd combination of one or more adi_fpga9010_FramerSel_e enum values
* \param txmode can be one of adi_fpga9010_TxDatamoverMode_e
*
* \retval ADI_FPGA9010_ACT_RESET_LOG Recovery action for log reset
* \retval ADI_COMMON_ACT_ERR_CHECK_PARAM Recovery action for bad parameter check
* \retval ADI_FPGA9010_ACT_INV_TX_DATA_MOVER_SETUP An invalid tx datamover selected
* \retval ADI_COMMON_ACT_NO_ACTION Function completed successfully, no action required
*
*/
//int32_t adi_fpga9010_TxModeSetup(adi_fpga9010_Device_t *device, adi_fpga_TramsmitMode_t transmitMode);
...
*
* \param device Pointer to the FPGA9010 device data structure.
* \param transmitModeMask can be one of adi_fpga9010_TxDatamoverMode_e
*
* \retval ADI_FPGA9010_ACT_RESET_LOG Recovery action for log reset
* \retval ADI_COMMON_ACT_ERR_CHECK_PARAM Recovery action for bad parameter check
* \retval ADI_FPGA9010_ACT_INV_TX_DATA_MOVER_SETUP An invalid tx datamover selected
...
* \retval ADI_COMMON_ACT_ERR_CHECK_PARAM Recovery action for bad parameter check
* \retval ADI_COMMON_ACT_NO_ACTION Function completed successfully, no action required
* \retval ADI_FPGA9010_ACT_INV_TX_DATA_MOVER_TRIGGER An invalid trigger type selected
*
*/
...
*
* \param device Pointer to the FPGA9010 device data structure.
* \param txDataMoverSel one of adi_fpga9010_FramerSel_e enum values
* \param triggerSelect can be a combination of adi_fpga_TrigSources_e
*
* \retval ADI_FPGA9010_ACT_RESET_LOG Recovery action for log reset
* \retval ADI_COMMON_ACT_ERR_CHECK_PARAM Recovery action for bad parameter check
...
*
* \param device Pointer to the FPGA9010 device data structure.
* \param txDataMoverSel the selected datamover to write to
* \param data the user provided array of data to write to the fpga.
* \param dataSize the size of the data array.
*
* \retval ADI_FPGA9010_ACT_RESET_LOG Recovery action for log reset
* \retval ADI_COMMON_ACT_ERR_CHECK_PARAM Recovery action for bad parameter check
* \retval ADI_FPGA9010_ACT_DATA_RX_MOVER_WAIT_TIMEOUT Timeout occurred during Rx transaction
* \retval ADI_COMMON_ACT_NO_ACTION Function completed successfully, no action required
*
*/
...
* \param device Pointer to the FPGA9010 device data structure.
* \param txDataMoverSelMask an or'd combination of one or more adi_fpga9010_FramerSel_e enum values
* \param numSamples the number of samples to be written from memory to the part.
*
* \retval ADI_FPGA9010_ACT_RESET_LOG Recovery action for log reset
* \retval ADI_COMMON_ACT_ERR_CHECK_PARAM Recovery action for bad parameter check
* \retval ADI_FPGA9010_ACT_DATA_RX_MOVER_WAIT_TIMEOUT Timeout occurred during Rx transaction
...
*           is configured using adi_fpga9010_TxTollgateTriggerSet,
*           the DMA is reset then configured using adi_fpga9010_TxDmaSet,
*           the DMA is started by setting the run-stop bit using adi_fpga9010_TxDmaRunStopSet,
...
* \param device Pointer to the FPGA9010 device data structure.
* \param txDatamoverSelMask an or'd combination of one or more adi_fpga9010_FramerSel_e enum values
* \param triggerSelect Select from adi_fpga9010_TxTollgateTrigSources_e enum
...
/**
* \brief    This function writes the static members of the adi_fpga9010_TxDmaCfg_t structure to the DMA
