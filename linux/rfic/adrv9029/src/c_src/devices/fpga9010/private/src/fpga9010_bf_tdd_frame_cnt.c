/**
 * \file fpga9010_bf_tdd_frame_cnt.c Automatically generated file with generator ver 0.0.0.1.
 *
 ...
 *  Parameter is of type ::fpga9010_BfTddFrameCntChanAddr_e.
                                         ...
                                         uint8_t bfValue)
{
        ...
        (bfValue > 1U))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         bfValue,
                         "Invalid fpga9010_TddFrameCntEnableBfSet parameter");
    ...
    /* Base Address check */
    if ((baseAddr != FPGA9010_BF_TDD_FRAME_COUNTER))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ADI_COMMON_ERRSRC_DEVICEBF, 
                         ADI_COMMON_ERR_INV_PARAM, 
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9010_TddFrameCntEnableBfSet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
                                         ...
                                         uint8_t *bfValue)
{
    ...
    if ((baseAddr != FPGA9010_BF_TDD_FRAME_COUNTER))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9010_TddFrameCntEnableBfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9010_BITFIELD_ADDR_CHECK */ 
...
/**
 * \brief End Value Indicates the End of Frame Counter
 * 
 * \dep_begin
 * \dep{device->common.devHalInfo}
 * \dep_end
                                           ...
                                           uint32_t bfValue)
{
        ...
        (bfValue > 4294967295U))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM, 
                         bfValue,
                         "Invalid fpga9010_TddFrameCntEndValueBfSet parameter");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9010_BITFIELD_VALUE_CHECK */
    ...
    if ((baseAddr != FPGA9010_BF_TDD_FRAME_COUNTER))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9010_TddFrameCntEndValueBfSet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9010_BITFIELD_ADDR_CHECK */ 
                                           ...
                                           uint32_t *bfValue)
{
    ...
    if ((baseAddr != FPGA9010_BF_TDD_FRAME_COUNTER))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9010_TddFrameCntEndValueBfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9010_BITFIELD_ADDR_CHECK */ 
...
/**
 * \brief Loop Count for the Frame Counter to Roll Over
 * 
 * \dep_begin
 * \dep{device->common.devHalInfo}
 * \dep_end
                                            ...
                                            uint32_t bfValue)
{
        ...
        (bfValue > 4294967295U))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM, 
                         bfValue,
                         "Invalid fpga9010_TddFrameCntLoopCountBfSet parameter");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9010_BITFIELD_VALUE_CHECK */
    ...
    if ((baseAddr != FPGA9010_BF_TDD_FRAME_COUNTER))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9010_TddFrameCntLoopCountBfSet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9010_BITFIELD_ADDR_CHECK */ 
                                            ...
                                            uint32_t *bfValue)
{
    ...
    if ((baseAddr != FPGA9010_BF_TDD_FRAME_COUNTER))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9010_TddFrameCntLoopCountBfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9010_BITFIELD_ADDR_CHECK */ 
                                              ...
                                              uint8_t bfValue)
{
        ...
        (bfValue > 1U))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM, 
                         bfValue,
                         "Invalid fpga9010_TddFrameCntLoopCountEnBfSet parameter");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9010_BITFIELD_VALUE_CHECK */
    ...
    if ((baseAddr != FPGA9010_BF_TDD_FRAME_COUNTER))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9010_TddFrameCntLoopCountEnBfSet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9010_BITFIELD_ADDR_CHECK */ 
                                          ...
                                          uint8_t bfValue)
{
        ...
        (bfValue > 1U))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM, 
                         bfValue,
                         "Invalid fpga9010_TddFrameCntTriggerBfSet parameter");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9010_BITFIELD_VALUE_CHECK */
    ...
    if ((baseAddr != FPGA9010_BF_TDD_FRAME_COUNTER))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9010_TddFrameCntTriggerBfSet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9010_BITFIELD_ADDR_CHECK */ 
                                          ...
                                          uint8_t *bfValue)
{
    ...
    if ((baseAddr != FPGA9010_BF_TDD_FRAME_COUNTER))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9010_TddFrameCntTriggerBfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9010_BITFIELD_ADDR_CHECK */ 
                                               ...
                                               uint8_t *bfValue)
{
    ...
    if ((baseAddr != FPGA9010_BF_TDD_FRAME_COUNTER))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9010_TddFrameCntVersionMajorBfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9010_BITFIELD_ADDR_CHECK */ 
                                               ...
                                               uint16_t *bfValue)
{
    ...
    if ((baseAddr != FPGA9010_BF_TDD_FRAME_COUNTER))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9010_TddFrameCntVersionMinorBfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9010_BITFIELD_ADDR_CHECK */ 
...
/*  EOF: fpga9010_bf_tdd_frame_cnt.c */
