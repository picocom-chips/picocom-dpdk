/**
 * \file fpga9010_bf_dp_capture_control.c Automatically generated file with generator ver 0.0.0.1.
 *
 ...
 *  Parameter is of type ::fpga9010_BfDpCaptureControlChanAddr_e.
                                                      ...
                                                      uint8_t bfValue)
{
        ...
        (bfValue > 1U))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         bfValue,
                         "Invalid fpga9010_DpCaptureControlDatapathActiveBfSet parameter");
    ...
    /* Base Address check */
    if ((baseAddr != FPGA9010_BF_DP_CAPTURE_CONTROL_RX) &&
            (baseAddr != FPGA9010_BF_DP_CAPTURE_CONTROL_TX))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ADI_COMMON_ERRSRC_DEVICEBF, 
                         ADI_COMMON_ERR_INV_PARAM, 
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9010_DpCaptureControlDatapathActiveBfSet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
                                                      ...
                                                      uint8_t *bfValue)
{
            ...
            (baseAddr != FPGA9010_BF_DP_CAPTURE_CONTROL_TX))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9010_DpCaptureControlDatapathActiveBfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9010_BITFIELD_ADDR_CHECK */ 
                                                          ...
                                                          uint8_t *bfValue)
{
            ...
            (baseAddr != FPGA9010_BF_DP_CAPTURE_CONTROL_TX))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9010_DpCaptureControlModuleVersionMajorBfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9010_BITFIELD_ADDR_CHECK */ 
                                                          ...
                                                          uint16_t *bfValue)
{
            ...
            (baseAddr != FPGA9010_BF_DP_CAPTURE_CONTROL_TX))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9010_DpCaptureControlModuleVersionMinorBfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9010_BITFIELD_ADDR_CHECK */ 
                                                 ...
                                                 uint8_t bfValue)
{
        ...
        (bfValue > 1U))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM, 
                         bfValue,
                         "Invalid fpga9010_DpCaptureControlPassTokenBfSet parameter");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9010_BITFIELD_VALUE_CHECK */
            ...
            (baseAddr != FPGA9010_BF_DP_CAPTURE_CONTROL_TX))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9010_DpCaptureControlPassTokenBfSet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9010_BITFIELD_ADDR_CHECK */ 
                                                 ...
                                                 uint8_t *bfValue)
{
            ...
            (baseAddr != FPGA9010_BF_DP_CAPTURE_CONTROL_TX))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9010_DpCaptureControlPassTokenBfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9010_BITFIELD_ADDR_CHECK */ 
                                             ...
                                             uint8_t bfValue)
{
        ...
        (bfValue > 1U))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM, 
                         bfValue,
                         "Invalid fpga9010_DpCaptureControlResetBfSet parameter");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9010_BITFIELD_VALUE_CHECK */
            ...
            (baseAddr != FPGA9010_BF_DP_CAPTURE_CONTROL_TX))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9010_DpCaptureControlResetBfSet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9010_BITFIELD_ADDR_CHECK */ 
                                             ...
                                             uint8_t *bfValue)
{
            ...
            (baseAddr != FPGA9010_BF_DP_CAPTURE_CONTROL_TX))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9010_DpCaptureControlResetBfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9010_BITFIELD_ADDR_CHECK */ 
...
/*  EOF: fpga9010_bf_dp_capture_control.c */
