...
*/
int32_t ads9_I2cOpen(void* devHalCfg)
{
...
* \retval ADI_HAL_OK Function completed successfully
*/
int32_t ads9_I2cClose(void* devHalCfg)
{
    int32_t           halError = (int32_t)ADI_HAL_OK;
    adi_hal_Cfg_t*    halCfg   = NULL;
    adi_hal_I2cCfg_t* i2cCfg   = NULL;
...
* \retval ADI_HAL_OK Function completed successfully
*/
int32_t ads9_I2cInit(void* devHalCfg)
{
    (void)(devHalCfg);
...
* \retval ADI_HAL_OK Function completed successfully
*/
int32_t ads9_I2cWrite(void*         devHalCfg,
...
* \retval ADI_HAL_OK Function completed successfully
*/
int32_t ads9_I2cRead(void*         devHalCfg,
                     const uint8_t txData[],
                     uint32_t      numTxBytes,
                     uint8_t       rxData[],
                     uint32_t      numRxBytes)
