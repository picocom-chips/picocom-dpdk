...
* \brief Contains FPGA9010 tx enum and struct definitions
*
...
#ifndef _ADI_FPGA9010_TX_TYPES_H_
#define _ADI_FPGA9010_TX_TYPES_H_
...
#define ADI_FPGA9010_NUM_OF_TX_DATAMOVERS 2

typedef enum adi_fpga9010_TxDatamoverMode
{
    ADI_FPGA9010_TXMODE_SNGL = 0,
    ADI_FPGA9010_TXMODE_CONT = 1
} adi_fpga9010_TxDatamoverMode_e;

/**
* \brief Enumerated list of fpga Tx Tollgata trigger sources
*/
typedef enum adi_fpga9010_TxTollgateTrigSources
{
    ADI_FPGA9010_TX_IMM_TRIG = 0x1,        /*!Immediate trigger. */
    ADI_FPGA9010_TX_EXT_TRIG = 0x2,        /*!External Trigger external SMA. */
    ADI_FPGA9010_TX_TDD_SM = 0x4,        /*!TDD State Machine. */
    ADI_FPGA9010_TX_ARM_ACK = 0x8        /*!GPIO. */
} adi_fpga9010_TxTollgateTrigSources_e;

/**
*  \brief Data structure to hold the Fpga Data mover tollgate Configuration
*/
typedef struct adi_fpga9010_TxTollgateCfg
{
    ...
    adi_fpga9010_TxTollgateTrigSources_e tollGateTrigSource;            /*!Selects the trigger input that is used to open the Tollgate. multiple triggers Supported */
} adi_fpga9010_TxTollgateCfg_t;

/**
*  \brief Data structure to hold the Fpga Data mover dma Configuration
*/
typedef struct adi_fpga9010_TxDmaCfg
{
...
} adi_fpga9010_TxDmaCfg_t;

#ifdef __cplusplus
}
#endif

#endif  /* _ADI_FPGA9010_TX_TYPES_H_ */
