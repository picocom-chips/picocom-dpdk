...
{
    ADI_ADRV9025_DPD_TRACKING_UPDATE_MODE_0 = 0,    /*!< DPD tracking updates in simple mode */
    ADI_ADRV9025_DPD_TRACKING_UPDATE_MODE_1,        /*!< DPD tracking updates in simple mode + maximum */
    ADI_ADRV9025_DPD_TRACKING_UPDATE_MODE_2         /*!< DPD tracking updates in hybrid mode */
...
typedef enum adi_adrv9025_DpdError
{
    ...
    ADI_ADRV9025_DPD_INVALID_PROFILE_ERROR = 0x340B,                        /*!< Deprecated - Error code to convey that the profile for DPD is invalid */
...
{
    ADI_ADRV9025_DPD_MODEL_TABLE_M = 0, /*!< DPD Model table used for signals within the max power range */
    ADI_ADRV9025_DPD_MODEL_TABLE_C = 1, /*!< DPD Model table used for signals below configured power threshold */
    ADI_ADRV9025_DPD_MODEL_TABLE_R = 2, /*!< DPD Model table used for DPD recovery. Derived from table M. */
    ADI_ADRV9025_DPD_MODEL_TABLE_U = 3  /*!< DPD Model table used for Unity Gain. Derived from table U. */
...
{
    ADI_ADRV9025_DPD_RECOVERY_ACTION_SKIP_LUTS_UPDATE       = 0x0001, /*!< Skip LUTs update */
    ADI_ADRV9025_DPD_RECOVERY_ACTION_REVERT_LUTS_TO_UNITY   = 0x0002, /*!< Revert all LUTs to unity */
    ADI_ADRV9025_DPD_RECOVERY_ACTION_RESET_ADAPTATION_STATE = 0x0004, /*!< Reset DPD adaptation state */
    ADI_ADRV9025_DPD_RECOVERY_ACTION_SWITCH_LUTS_TO_M       = 0x0008, /*!< Switch LUTs to M */
    ADI_ADRV9025_DPD_RECOVERY_ACTION_SWITCH_LUTS_TO_R       = 0x0010, /*!< Switch LUTs to R */
    ADI_ADRV9025_DPD_RECOVERY_ACTION_6DB_DIG_ATTEN          = 0x0020, /*!< Attenuate signal by 6 dB */
    ADI_ADRV9025_DPD_RECOVERY_ACTION_RESET_FIRST_DPD_FLAG   = 0x0040  /*!< Reset first DPD flag */
...
{
    ADI_ADRV9025_DPD_METRIC_MEAN_TU_POWER   = 0x0001, /*!< pre-dpd Tx mean power */
    ADI_ADRV9025_DPD_METRIC_PEAK_TU_POWER   = 0x0002, /*!< pre-dpd Tx peak power */
    ADI_ADRV9025_DPD_METRIC_MEAN_TX_POWER   = 0x0004, /*!< post-dpd Tx mean power */
    ADI_ADRV9025_DPD_METRIC_PEAK_TX_POWER   = 0x0008, /*!< post-dpd Tx peak power */
    ADI_ADRV9025_DPD_METRIC_MEAN_ORX_POWER  = 0x0010, /*!< Orx mean power */
    ADI_ADRV9025_DPD_METRIC_PEAK_ORX_POWER  = 0x0020, /*!< Orx peak power */
    ADI_ADRV9025_DPD_METRIC_DIRECT_EVM      = 0x0040, /*!< pre-dpd Tx and Orx data error */
    ADI_ADRV9025_DPD_METRIC_INDIRECT_EVM    = 0x0080, /*!< post-dpd Tx and Orx data error */
    ADI_ADRV9025_DPD_METRIC_SELECT_ERROR    = 0x0100, /*!< selected post-dpd Tx and estimate error */
    ADI_ADRV9025_DPD_METRIC_INDIRECT_ERROR  = 0x0200  /*!< post-dpd Tx and estimate error */
...
typedef enum adi_adrv9025_DpdErrorState
{
    ...
    ADI_ADRV9025_DPD_ERR_STATE_PERSISTENT_0,    /*!< Error state where threshold 0 has been surpassed a certain number of times */
    ADI_ADRV9025_DPD_ERR_STATE_PERSISTENT_1     /*!< Error state where threshold 1 has been surpassed a certain number of times */
...
typedef enum adi_adrv9025_CfrModeSel
{
    ...
    ADI_ADRV9025_CFR_MODE2 = 1, /*!< User to provide the base correction pulse in this mode which will be post processed by the ADRV9025 firmware to generate the final correction pulse */
    ADI_ADRV9025_CFR_MODE3 = 2  /*!< The firmware uses a set of internal base pulses corresponding to a set of pre-defined carrier signals to generate the final correction pulse */
...
typedef enum adi_adrv9025_ClgcRunState
{
    ...
    ADI_ADRV9025_CLGC_ASSERT_PA_PROTECTION = 7    /*!< CLGC algorithm has detected a PA protection assertion */
...
{
    ADI_ADRV9025_SAMPLES_PER_CAP_1024 = 1024,
    ADI_ADRV9025_SAMPLES_PER_CAP_2048 = 2048,
    ADI_ADRV9025_SAMPLES_PER_CAP_4096 = 4096
...
typedef struct adi_adrv9025_DpdModelConfig
{
    ...
    uint8_t dpdNumFeatures;                                               /*!< No. of features contained in the DPD model. Currently 63 features are supported */
...
typedef struct adi_adrv9025_DpdStatistics
{
    ...
    float dpdSelectError;   /*!< selected indirect error in one capture duration. Multiply by 100 to get value in % */
    float dpdIndirectError; /*!< indirect error in one capture duration. Multiply by 100 to get value in % */
...
{
    adi_adrv9025_DpdError_e dpdErrorCode; /*!< Error code from Tx DPD */
    uint32_t dpdPercentComplete;                        /*!< Percentage completion of DPD adaptation. Range 0 to 100 */
    uint32_t dpdIterCount;                /*!< Running counter that increments each time the DPD adaptation executes */
    uint32_t dpdUpdateCount;              /*!< Running counter that increments each time the cal updates the correction/actuator hardware */
    adi_adrv9025_TrackingCalSyncStatus_e dpdSyncStatus; /*!< Enum to denote the status of CLGC and DPD synchronization */
    adi_adrv9025_DpdModelTableSel_e dpdModelTable;      /*!< DPD Model table selected */
...
typedef struct adi_adrv9025_DpdTrackingConfig
{
    ...
    uint8_t  dpdIndirectRegularizationValue;    /*!< Indirect regularization value. Maximum value of 63 */
    uint8_t  dpdDirectRegularizationValue;      /*!< Direct regularization value. Maximum value of 63 */
    uint16_t dpdSamples;                        /*!< Number of samples to capture per adaptation */
    uint32_t dpdMThreshold;                     /*!< M table threshold when ADI_ADRV9025_DPD_TRACKING_UPDATE_MODE_2 (hybrid) is used. Maximum value of 2147483648 */
    uint32_t dpdPeakSearchWindowSize;           /*!< Number of samples to search a peak from. Maximum value of 16777215 */
    adi_adrv9025_DpdTrackingUpdateMode_e dpdUpdateMode; /*!< Update mode of DPD tracking. 0: simple, 1: simple + max, 2: hybrid */
    adi_adrv9025_DpdFilterCoeffWeight_t dpdFilterCoeffWeight[ADI_ADRV9025_MAX_DPD_FILTER]; /*!< Reserved for future use */
    uint16_t minAvgSignalLevel;                 /*!< DPD low power threshold in linear scale below which DPD stops tracking. The default value is -36dBFS. It can be converted to dBFS as 20log10(minAvgSignalLevel/FULL_SCALE) */
    uint8_t dpdMu;                              /*!< DPD direct learning step size values range from 0 to 100 */
    uint16_t minAvgSignalLevelOrx;              /*!< DPD low power threshold ORX in linear scale below which DPD stops tracking. The default value is -36dBFS. It can be converted to dBFS as 20log10(minAvgSignalLevel/FULL_SCALE) */
    uint16_t dpdFilterSel;                      /*!< OBW filter select either  0.5*fs or 0.8*fs (valid values 0-1 respectively)*/
    uint8_t  enableDirectLearning;              /*!< Option to enable direct learning (defaulte 0 which is off , set to 1 to enable direct learning */
    uint16_t  dpdIndirectRegularizationLowPowerValue;       /*!< Indirect low power regularization value. only valid when in DPD mode 2, Maximum value of 63 */
...
typedef struct adi_adrv9025_EnhancedDpdTrackingConfig
{
    ...
    uint8_t  enableWidebandRegularization;     /*!< Wideband regularization feature enable, (1: enable, 0: disable) */
    float    widebandRegularizationFactor;     /*!< Wideband regularization feature factor, range from 0 to 1, step: 0.00001 */
