/**
 * \file fpga9025_bf_ila_trigger.c Automatically generated file with generator ver 0.0.1.0.
 *
...
#include "./../../private/include/fpga9025_bf_ila_trigger.h"
 ...
 *  Parameter is of type ::fpga9025_BfIlaTriggerChanAddr_e.
                                                   ...
                                                   uint8_t*                        bfValue)
{
    ...
    /* Base Address check */
    if ((baseAddr != FPGA9025_BF_ILA_TRIGGER))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         baseAddr, 
                         "Invalid fpga9025_IlaTriggerModuleVersionMajorBfGet Address");
                                                   ...
                                                   uint16_t*                       bfValue)
{
    ...
    if ((baseAddr != FPGA9025_BF_ILA_TRIGGER))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9025_IlaTriggerModuleVersionMinorBfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_ADDR_CHECK */
                                        ...
                                        uint32_t                        bfValue)
{
        ...
        (bfValue > 4294967295U))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM, 
                         bfValue,
                         "Invalid fpga9025_IlaTriggerTriggerBfSet parameter");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
    ...
    if ((baseAddr != FPGA9025_BF_ILA_TRIGGER))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9025_IlaTriggerTriggerBfSet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_ADDR_CHECK */
                                        ...
                                        uint32_t*                       bfValue)
{
    ...
    if ((baseAddr != FPGA9025_BF_ILA_TRIGGER))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9025_IlaTriggerTriggerBfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9025_BITFIELD_ADDR_CHECK */
