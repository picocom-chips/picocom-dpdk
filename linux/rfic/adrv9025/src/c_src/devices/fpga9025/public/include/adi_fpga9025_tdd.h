...
#ifndef _ADI_FPGA9025_TDD_H_
#define _ADI_FPGA9025_TDD_H_
...
*
* \retval ADI_COMMON_ACT_NO_ACTION Function completed successfully, no action required
* \retval ADI_FPGA9025_ACT_INV_TDD_ASSERT_SELECT Invalid bits were selected when asserting TDD pins
*
*/
...
*
* \retval ADI_FPGA9025_ACT_NO_ACTION Function completed successfully, no action required
* \retval ADI_FPGA9025_ACT_INV_TDD_ASSERT_SELECT Invalid bits were selected when asserting TDD pins
*
*/
...
*
* \param device Pointer to the FPGA9025 device data structure.
* \param orxPinEncodeCfg Pointer to a filled out adi_fpga9025_OrxPinEncodeCfg_t structure 
*
* \retval ADI_FPGA9025_ACT_NO_ACTION Function completed successfully, no action required
*
*/
...
*
* \param device Pointer to the FPGA9025 device data structure.
* \param orxPinEncodeCfg Pointer to a adi_fpga9025_OrxPinEncodeCfg_t structure to be filled with current module values
*
* \retval ADI_FPGA9025_ACT_NO_ACTION Function completed successfully, no action required
*
*/
