...
static int port_init( uint16_t pc802_index )
{
    ...
    RTE_ASSERT(0 == pc802_create_tx_queue(port_id, PC802_TRAFFIC_OAM, OAM_QUEUE_BLOCK_SIZE, 128, 64));
    RTE_ASSERT(0 == pc802_create_rx_queue(port_id, PC802_TRAFFIC_OAM, OAM_QUEUE_BLOCK_SIZE, 128, 64));

    printf("Finished %d OAM port_init !\n", pc802_index );
